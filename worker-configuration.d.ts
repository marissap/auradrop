/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 030e7063a7c4ac5a46a918330dcc7fe5)
// Runtime types generated with workerd@1.20260301.1 2026-03-04 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GeoTarget" | "AuraDropAgent";
	}
	interface Env {
		ASSETS: Fetcher;
		GEO_TARGET: DurableObjectNamespace<import("./src/worker").GeoTarget>;
		AURA_AGENT: DurableObjectNamespace<import("./src/worker").AuraDropAgent>;
	}
}
